		...
		try {
			 ...
			 */		
             ...
             for (long i = startSeed; i <= endSeed; i++) {
               double score = LineUpVis.main(new String[]{ "-exec", exec, "-seed", i + "", "-novis" });
               long runTime = LineUpVis.runTime;
               ...
               allOutput.append("Run Time = " + runTime + "ms\n\n");
               allOutput.append(LineUpVis.output.getOutput());
               allOutput.append("\n\n");
             }
             try {
